                    ...
                    <form class="my-8 text-sm" @submit.prevent="signup">
                        ...
                        <div class="flex flex-col my-4">
                            ...
                            <div class="relative flex items-center mt-2">
                                <input v-model="password" :type="showpass ? 'text' : 'password'" name="password"
                                ...
                                <button @click="togglePassShow" type="button"
                        ...
                        <div class="flex flex-col my-4">
                            ...
                            <div class="relative flex items-center mt-2">
                                <input v-model="retypePassword" :type="showrepass ? 'text' : 'password'" name="retypePassword"
                                    class="flex-1 p-2 pr-10 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900"
                                    placeholder="Nhập lại mật khẩu">
                                <button @click="toggleRePassShow" type="button"
                                    class="absolute right-2 bg-transparent flex items-center justify-center text-gray-700">
                                    <svg v-if="!showrepass" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21">
                                        </path>
                        ...
                        <div class="my-4 flex items-center justify-end space-x-4">
                            <button class="bg-blue-600 hover:bg-blue-700 rounded-lg px-8 py-2 text-gray-100 hover:shadow-xl transition duration-150 uppercase">Đăng kí</button>
                        </div>
                    </form>
...
export default {
  ...
  methods: {
    togglePassShow() { this.showpass = !this.showpass; },
    toggleRePassShow() { this.showrepass = !this.showrepass; },
    async signup() {
      try {
