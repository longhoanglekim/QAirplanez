<template>
  <div>
    ...
    <div class="flex justify-center">
      <router-link to="" class="flex justify-center items-center h-48 w-64 border-2 border-orange-500 rounded-lg text-orange-500 p-3 m-4">
        <div class="">
          <Ticket class="w-24 h-24"/>
          <span class="text-[1.5rem]">Đặt vé</span>
        </div>
      </router-link>
      <a href="/explore" class="flex justify-center items-center h-48 w-64 border-2 border-orange-500 rounded-lg text-orange-500 p-3 m-4">
        <div class="">
          <Earth class="w-24 h-24"/>
          <span class="text-[1.5rem]">Địa điểm</span>
        </div>
      </a>
      <router-link to="#news" class="flex justify-center items-center h-48 w-64 border-2 border-orange-500 rounded-lg text-orange-500 p-3 m-4">
        <div class="">
          <Ticket class="w-24 h-24"/>
    ...
    <div class="custom-bg h-full p-8">
      <div id="news" class="space-x-0 md:space-x-6 mb-16 bg-white rounded-lg shadow-sm p-8 transition-all duration-300 ">
          ...
          <div class="w-full md:w-1/2">
            <div v-for="post in otherHotNews" :key="post.title"
              ...
              <router-link :to="`/news/${post.title}`"
                ...
                <div class="flex flex-col md:flex-row w-full transition-all duration-300 group-hover:bg-orange-50 p-2">
                  <img :src="post.image"
                  ...
                  <div class="bg-transparent px-4 py-3 w-full md:w-3/4 ml-0 md:ml-4">
                    ...
                    <p class="text-orange-900 text-sm line-clamp-2 transition-colors duration-300 group-hover:text-red-700">
                      {{ post.content }}
                    </p>
            ...
            <div class="text-center mt-8">
              <router-link to="/news" class="text-red-600 text-sm font-medium transition-colors duration-300 hover:text-red-700">
                View all articles →
              </router-link>
            </div>
          </div>
