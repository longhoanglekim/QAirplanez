      ...
      <div class="flex items-center space-x-4">
        ...
        <div v-if="isLoggedIn()" class="group relative cursor-pointer p-2">
          ...
          <div class="group-hover:visible invisible absolute right-0 z-50 p-0.5 bg-white rounded text-gray-800 shadow-xl text-left w-48">
            <button @click="handleProfileItemClick(profileItems[0])" class="block rounded px-6 py-3 text-gray-800 hover:text-blue-900 hover:bg-gray-100 transition-colors w-48">
              {{ profileItems[0].label }}
            </button>
            <button @click="handleProfileItemClick(profileItems[1])" class="block rounded px-6 py-3 text-gray-800 hover:text-blue-900 hover:bg-gray-100 transition-colors w-48">
              {{ profileItems[1].label }}
            </button>
            <button @click="handleProfileItemClick(profileItems[2])" class="block rounded px-6 py-3 text-gray-800 hover:text-blue-900 hover:bg-gray-100 transition-colors w-48">
