...
CREATE TABLE `flights` (
                           ...
                           `aircraft_aircraft_id` bigint DEFAULT NULL,
                           `departure_airport_airport_id` int DEFAULT NULL,
                           `destination_airport_airport_id` int DEFAULT NULL,
                           PRIMARY KEY (`flight_id`),
                           KEY `FKlref405f4r8lfgiu9gbwbdtgv` (`aircraft_aircraft_id`),
                           KEY `FK1oo8ervoj8230wtvebwrqu2tf` (`departure_airport_airport_id`),
                           KEY `FKny1g2v5rad7ben4t7vq8yjlyr` (`destination_airport_airport_id`),
                           CONSTRAINT `FK1oo8ervoj8230wtvebwrqu2tf` FOREIGN KEY (`departure_airport_airport_id`) REFERENCES `airports` (`airport_id`),
                           CONSTRAINT `FKlref405f4r8lfgiu9gbwbdtgv` FOREIGN KEY (`aircraft_aircraft_id`) REFERENCES `aircrafts` (`aircraft_id`),
                           CONSTRAINT `FKny1g2v5rad7ben4t7vq8yjlyr` FOREIGN KEY (`destination_airport_airport_id`) REFERENCES `airports` (`airport_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `passengers` (
                              ...
                              KEY `FK5rwljsnya2tdu14sy99r39k1b` (`flight_flight_id`),
                              CONSTRAINT `FK5rwljsnya2tdu14sy99r39k1b` FOREIGN KEY (`flight_flight_id`) REFERENCES `flights` (`flight_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
